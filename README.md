...
Built following cloud-skills-roadmap Month 6 RAG Pipeline project. Vector database from Qdrant. LLM capabilities from Ollama and OpenAI. Framework support from LangChain.
